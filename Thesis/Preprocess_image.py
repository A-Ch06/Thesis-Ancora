...
def process_images_in_folder(folder_path):
    ...
    """
    # Get all image files from the folder (you can add more image extensions if needed)
...
folder_path = "D:\\Thesis\\Food_Images"  # Change to your folder path containing images
